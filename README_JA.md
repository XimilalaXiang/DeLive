...
|:---:|:---:|:---:|
| マルチプロバイダー対応のリアルタイム文字起こしワークスペース | カレンダーと検索付きのセッション履歴 | プロジェクト単位のセッション整理 |
| <img width="300" src="assets/screenshot-live-light.webp" alt="ライブビュー" /> | <img width="300" src="assets/screenshot-review.webp" alt="レビュービュー" /> | <img width="300" src="assets/screenshot-topics.webp" alt="トピックビュー" /> |

| テーマとカスタマイズ | ダークモード |
|:---:|:---:|
| 5 色テーマ、完全なライト/ダークモード対応 | 全ビューでダークモード対応 |
| <img width="400" src="assets/screenshot-settings-themes.webp" alt="テーマ設定" /> | <img width="400" src="assets/screenshot-settings-dark.webp" alt="ダークモード" /> |
