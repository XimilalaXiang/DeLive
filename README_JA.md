...
| リアルタイム文字起こし | 字幕オーバーレイ |
|:---:|:---:|
| マルチプロバイダー ASR リアルタイム文字起こし | ドラッグ可能な常時最前面字幕ウィンドウ |
| <img width="400" src="assets/screenshot-live.png" alt="リアルタイム文字起こし" /> | <img width="400" src="assets/screenshot-caption-overlay.png" alt="字幕オーバーレイ" /> |

| MCP 統合 |
|:---:|
| 外部 AI ツールが MCP プロトコルで DeLive の文字起こしデータにアクセス |
| <img width="600" src="assets/screenshot-mcp-integration.png" alt="MCP 統合" /> |

| レビューと履歴 | トピック管理 | 文字起こし詳細 |
|:---:|:---:|:---:|
| アクティビティヒートマップと検索付きセッション履歴 | プロジェクト単位のセッション整理 | タイムスタンプと話者識別付きの文字起こしテキスト |
| <img width="300" src="assets/screenshot-review-history.png" alt="レビューと履歴" /> | <img width="300" src="assets/screenshot-topics-view.png" alt="トピック管理" /> | <img width="300" src="assets/screenshot-transcript-detail.png" alt="文字起こし詳細" /> |
...
| 字幕スタイル設定 | 設定 |
|:---:|:---:|
| ライブプレビュー付き字幕スタイルエディター | プロバイダー設定と認証情報管理 |
| <img width="400" src="assets/screenshot-caption-style.png" alt="字幕スタイル" /> | <img width="400" src="assets/screenshot-settings-api.png" alt="設定" /> |
