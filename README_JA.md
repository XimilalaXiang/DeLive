...
| 字幕スタイル設定 | 設定 | MCP 統合 |
|:---:|:---:|:---:|
| ライブプレビュー付き字幕スタイルエディター | プロバイダー設定と認証情報管理 | 外部 AI ツールが MCP プロトコルで DeLive にアクセス |
| <img width="300" src="assets/screenshot-caption-style.png" alt="字幕スタイル" /> | <img width="300" src="assets/screenshot-settings-api.png" alt="設定" /> | <img width="300" src="assets/screenshot-mcp-integration.png" alt="MCP 統合" /> |
