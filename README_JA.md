...
| リアルタイム文字起こし | レビューと履歴 | トピック管理 |
|:---:|:---:|:---:|
| フローティング字幕ウィンドウ付きリアルタイム文字起こし | アクティビティヒートマップと検索付きセッション履歴 | プロジェクト単位のセッション整理 |
| <img width="300" src="assets/screenshot-live.png" alt="リアルタイム文字起こし" /> | <img width="300" src="assets/screenshot-review-history.png" alt="レビューと履歴" /> | <img width="300" src="assets/screenshot-topics-view.png" alt="トピック管理" /> |

| AI 概要 | AI チャット | 字幕スタイル設定 |
|:---:|:---:|:---:|
| 要約、アクションアイテム、キーワード、チャプター | 引用付きマルチスレッド会話 | ライブプレビュー付き字幕スタイルエディター |
| <img width="300" src="assets/screenshot-ai-overview.png" alt="AI 概要" /> | <img width="300" src="assets/screenshot-ai-chat.png" alt="AI チャット" /> | <img width="300" src="assets/screenshot-caption-style.png" alt="字幕スタイル" /> |

| マインドマップ | 文字起こし詳細 | MCP 統合 |
|:---:|:---:|:---:|
| 文字起こし内容から自動生成されるマインドマップ | タイムスタンプと話者識別付きの文字起こしテキスト | 外部 AI ツールが MCP プロトコルで DeLive にアクセス |
| <img width="300" src="assets/screenshot-mindmap.png" alt="マインドマップ" /> | <img width="300" src="assets/screenshot-transcript-detail.png" alt="文字起こし詳細" /> | <img width="300" src="assets/screenshot-mcp-integration.png" alt="MCP 統合" /> |

| 設定 | 字幕オーバーレイ |
|:---:|:---:|
| プロバイダー設定と認証情報管理 | ドラッグ可能な常時最前面字幕ウィンドウ |
| <img width="400" src="assets/screenshot-settings-api.png" alt="設定" /> | <img width="400" src="assets/screenshot-caption-overlay.png" alt="字幕オーバーレイ" /> |
