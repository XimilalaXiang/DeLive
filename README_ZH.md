...
| 实时转录 | 字幕悬浮窗 |
|:---:|:---:|
| 多 Provider ASR 实时转录 | 可拖拽的置顶字幕悬浮窗 |
| <img width="400" src="assets/screenshot-live.png" alt="实时转录" /> | <img width="400" src="assets/screenshot-caption-overlay.png" alt="字幕悬浮窗" /> |

| MCP 集成 |
|:---:|
| 外部 AI 工具通过 MCP 协议访问 DeLive 转录数据 |
| <img width="600" src="assets/screenshot-mcp-integration.png" alt="MCP 集成" /> |

| 复盘与历史 | 主题管理 | 转录详情 |
|:---:|:---:|:---:|
| 带活动热力图和搜索的会话历史 | 基于项目的会话归类管理 | 带时间戳和说话人识别的转录文本 |
| <img width="300" src="assets/screenshot-review-history.png" alt="复盘与历史" /> | <img width="300" src="assets/screenshot-topics-view.png" alt="主题管理" /> | <img width="300" src="assets/screenshot-transcript-detail.png" alt="转录详情" /> |
...
| 字幕样式设置 | 设置 |
|:---:|:---:|
| 字幕样式编辑器，实时预览 | Provider 配置与凭证管理 |
| <img width="400" src="assets/screenshot-caption-style.png" alt="字幕样式" /> | <img width="400" src="assets/screenshot-settings-api.png" alt="设置" /> |
