...
| 字幕样式设置 | 设置 | MCP 集成 |
|:---:|:---:|:---:|
| 字幕样式编辑器，实时预览 | Provider 配置与凭证管理 | 外部 AI 工具通过 MCP 协议访问 DeLive |
| <img width="300" src="assets/screenshot-caption-style.png" alt="字幕样式" /> | <img width="300" src="assets/screenshot-settings-api.png" alt="设置" /> | <img width="300" src="assets/screenshot-mcp-integration.png" alt="MCP 集成" /> |
