...
首次執行 DeLive 時，Windows 可能會顯示 SmartScreen 警告，提示「Windows 已保護您的電腦」。這是**正常現象**，因為新應用程式尚未在微軟建立信譽。

**為什麼會出現這個警告？**
- DeLive 是開源專案，沒有購買付費的程式碼簽章憑證
- 新發布且下載量較少的應用會觸發此警告
- 這並**不代表**軟體有害

**如何繼續執行：**
1. 點擊警告對話方塊中的 **「更多資訊」**
2. 點擊 **「仍要執行」** 即可啟動 DeLive

**驗證安全性：**
- [VirusTotal 掃描結果](https://www.virustotal.com/gui/file/cdc1680fd693ac7b1c08980e8af5b04edf42289a051f9e7ecd4d915db9bce24b/detection) - 可驗證應用程式是安全的
- 原始碼完全開源，可在 GitHub 上審查
