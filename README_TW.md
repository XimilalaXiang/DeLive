...
| 即時轉錄 | 複盤與歷史 | 主題管理 |
|:---:|:---:|:---:|
| 帶懸浮字幕窗的即時轉錄 | 帶活動熱力圖和搜尋的會話歷史 | 基於專案的會話歸類管理 |
| <img width="300" src="assets/screenshot-live.png" alt="即時轉錄" /> | <img width="300" src="assets/screenshot-review-history.png" alt="複盤與歷史" /> | <img width="300" src="assets/screenshot-topics-view.png" alt="主題管理" /> |

| AI 概覽 | AI 對話 | 字幕樣式設定 |
|:---:|:---:|:---:|
| 摘要、行動項、關鍵詞與章節 | 多執行緒對話，帶引用片段 | 字幕樣式編輯器，即時預覽 |
| <img width="300" src="assets/screenshot-ai-overview.png" alt="AI 概覽" /> | <img width="300" src="assets/screenshot-ai-chat.png" alt="AI 對話" /> | <img width="300" src="assets/screenshot-caption-style.png" alt="字幕樣式" /> |

| 思維導圖 | 轉錄詳情 | MCP 整合 |
|:---:|:---:|:---:|
| 從轉錄內容自動生成思維導圖 | 帶時間戳和說話人識別的轉錄文本 | 外部 AI 工具透過 MCP 協定存取 DeLive |
| <img width="300" src="assets/screenshot-mindmap.png" alt="思維導圖" /> | <img width="300" src="assets/screenshot-transcript-detail.png" alt="轉錄詳情" /> | <img width="300" src="assets/screenshot-mcp-integration.png" alt="MCP 整合" /> |

| 設定 | 字幕懸浮窗 |
|:---:|:---:|
| Provider 設定與憑證管理 | 可拖曳的置頂字幕懸浮窗 |
| <img width="400" src="assets/screenshot-settings-api.png" alt="設定" /> | <img width="400" src="assets/screenshot-caption-overlay.png" alt="字幕懸浮窗" /> |
