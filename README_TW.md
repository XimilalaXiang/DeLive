...
| 即時轉錄 | 字幕懸浮窗 |
|:---:|:---:|
| 多 Provider ASR 即時轉錄 | 可拖曳的置頂字幕懸浮窗 |
| <img width="400" src="assets/screenshot-live.png" alt="即時轉錄" /> | <img width="400" src="assets/screenshot-caption-overlay.png" alt="字幕懸浮窗" /> |

| MCP 整合 |
|:---:|
| 外部 AI 工具透過 MCP 協定存取 DeLive 轉錄資料 |
| <img width="600" src="assets/screenshot-mcp-integration.png" alt="MCP 整合" /> |

| 複盤與歷史 | 主題管理 | 轉錄詳情 |
|:---:|:---:|:---:|
| 帶活動熱力圖和搜尋的會話歷史 | 基於專案的會話歸類管理 | 帶時間戳和說話人識別的轉錄文本 |
| <img width="300" src="assets/screenshot-review-history.png" alt="複盤與歷史" /> | <img width="300" src="assets/screenshot-topics-view.png" alt="主題管理" /> | <img width="300" src="assets/screenshot-transcript-detail.png" alt="轉錄詳情" /> |
...
| 字幕樣式設定 | 設定 |
|:---:|:---:|
| 字幕樣式編輯器，即時預覽 | Provider 設定與憑證管理 |
| <img width="400" src="assets/screenshot-caption-style.png" alt="字幕樣式" /> | <img width="400" src="assets/screenshot-settings-api.png" alt="設定" /> |
