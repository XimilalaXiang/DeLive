...
| 字幕樣式設定 | 設定 | MCP 整合 |
|:---:|:---:|:---:|
| 字幕樣式編輯器，即時預覽 | Provider 設定與憑證管理 | 外部 AI 工具透過 MCP 協定存取 DeLive |
| <img width="300" src="assets/screenshot-caption-style.png" alt="字幕樣式" /> | <img width="300" src="assets/screenshot-settings-api.png" alt="設定" /> | <img width="300" src="assets/screenshot-mcp-integration.png" alt="MCP 整合" /> |
