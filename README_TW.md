...
- [x] **10 條 ASR 路徑統一在一個 UI 裡** — Soniox、火山引擎、Groq、矽基流動、Mistral AI、Deepgram、AssemblyAI、ElevenLabs、本地 OpenAI-compatible、本地 `whisper.cpp`
...
目前測試狀態：**29 個測試檔案、266 個測試案例全部通過**，涵蓋 Provider 設定、轉錄狀態/穩定化、字幕匯出、會話生命週期與倉儲、儲存、雲端備份、Open API IPC 回應、AI 後處理解析以及轉錄文本源解析。
