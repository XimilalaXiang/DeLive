...
export const en: Translations = {
  ...
  provider: {
    ...
    soniox: 'Soniox V5',
    elevenlabsDesc: 'ElevenLabs Scribe v2 Realtime (Standard / Turbo / Lite), 90+ languages, latency as low as 150ms',
    mistralDesc: 'Mistral Voxtral realtime transcription, 13 languages',
    gladiaDesc: 'Gladia Solaria-1 realtime transcription; file jobs support Solaria-1 or Solaria-3 (async EU languages)',
    deepgramDesc: 'Deepgram Nova-3 realtime transcription, 45+ languages including Mandarin and Cantonese',
    assemblyaiDesc: 'AssemblyAI Universal-3.5 Pro realtime and file transcription, 99+ languages, with speaker diarization',
    ...
    fieldElevenlabsModelDesc: 'Realtime streaming model: Standard (default), Turbo, or Lite.',
    fieldGladiaFileModel: 'File Transcription Model',
    fieldGladiaFileModelDesc: 'Async/file only. Live streaming always uses Solaria-1. Solaria-3 is limited to EN/FR/DE/ES/IT.',
