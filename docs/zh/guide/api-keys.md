...
::: warning 中文支持有限
Deepgram 主要针对英语优化，中文转录效果一般。如需中文转录，推荐 Soniox、火山引擎、硅基流动 或 ElevenLabs。
:::
...
::: warning 中文支持有限
AssemblyAI 主要针对英语优化，中文转录效果一般。如需中文转录，推荐 Soniox、火山引擎、硅基流动 或 ElevenLabs。
:::
...
| 中文内容 | Soniox、火山引擎、硅基流动、ElevenLabs | Deepgram/AssemblyAI 对中文支持有限 |
